 ...
 */
public class HpLib_HlsHpLibRendererBuilder implements HpLibRendererBuilder {
    ...
    public HpLib_HlsHpLibRendererBuilder(VideoPlayActivity player, String userAgent, String video_url) {
        this.context = player;
    ...
    @Override
    public void buildRenderers(VideoPlayActivity player) {
    ...
    private static final class AsyncRendererBuilder implements ManifestFetcher.ManifestCallback<HlsPlaylist> {
        ...
        private final String userAgent;
        private final String url;
        private final VideoPlayActivity player;
        private final ManifestFetcher<HlsPlaylist> playlistFetcher;
        private boolean canceled;

        public AsyncRendererBuilder(Context context, String userAgent, String url, VideoPlayActivity player) {
        ...
        public void onSingleManifest(HlsPlaylist manifest) {
            ...
            HlsSampleSource sampleSource = new HlsSampleSource(chunkSource, loadControl, MAIN_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player, VideoPlayActivity.TYPE_VIDEO);
